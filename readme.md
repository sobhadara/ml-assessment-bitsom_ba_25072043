...
3.  **The Alarm System:** We monitor for **Model Drift**. If the model's guesses start becoming more than 15% wrong compared to real sales, an alarm goes off telling us it's time to "retrain" the model with the latest data.
